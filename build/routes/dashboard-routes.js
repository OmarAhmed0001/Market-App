...
router.get('/userOrders/:id', auth_1.check_token, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, dashboard.userOrders(id)];
            case 1:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 3];
...
router.get('/completeduserOrders/:id', auth_1.check_token, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = parseInt(req.params.id);
                return [4 /*yield*/, dashboard.CompleteduserOrders(id)];
            case 1:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 3];
