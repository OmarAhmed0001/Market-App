...
router.get('/index', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1;
...
router.get('/show/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
router.post('/create', auth_1.check_token, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var thisproduct, newproduct, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, product.create(thisproduct)];
            case 1:
                newproduct = _a.sent();
                res.json(newproduct);
                return [3 /*break*/, 3];
