...
describe('dashboard tests', function () {
    it('should return empty object', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dashboard.CompleteduserOrders(1)];
                case 1:
                    result = _a.sent();
                    console.log(result);
    ...
    it('should return []', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dashboard.userOrders(1)];
                case 1:
                    result = _a.sent();
                    console.log(result);
                    expect(result).toEqual([]);
