...
describe('producr tests', function () {
    it('should should have an index method', function () {
    ...
    it('should return the object we just created', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
