...
var database_1 = __importDefault(require("../config/database/database"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("unable get products belongs to user :".concat(id, " error: ").concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    DashboardQueries.prototype.CompleteduserOrders = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [id, id, 'complete'])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows];
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable get products belongs to user :".concat(id, " error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
